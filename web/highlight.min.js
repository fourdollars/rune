...
className:"link",begin:/:\s*/,end:/$/,excludeBegin:!0}]},{scope:"literal",
match:/&([a-zA-Z0-9]+|#[0-9]{1,7}|#[Xx][0-9a-fA-F]{1,6});/}]}}})()
;hljs.registerLanguage("markdown",e)})();/*! `go` grammar compiled for Highlight.js 11.11.1 */
...
illegal:"\\S"}}})();hljs.registerLanguage("json",e)})();/*! `ini` grammar compiled for Highlight.js 11.11.1 */
