const actions = {
    ...
    'toggle-log-detail': element => toggleLogDetail(element),
    'copy-log-output': element => copyLogOutput(element),
    ...
    'select-thinking-level': element => { switchThinking(element.dataset.level); hideThinkingDialog(); },
    ...
    'toggle-tree-drawer': () => toggleNotesPanel(),
