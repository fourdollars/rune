...
mod integration_tests {
    ...
    fn test_state(tmp: &TempDir) -> ServerState {
        ...
        ServerState {
            ...
            models: Arc::new(RwLock::new(vec![ModelInfo { id: "gpt-5-mini".into(), context_window: None, reasoning_efforts: vec![] }, ModelInfo { id: "claude-sonnet-4.6".into(), context_window: None, reasoning_efforts: vec![] }])),
    ...
    async fn test_file_visibility_change_broadcasts_note_list_to_all_rooms() {
        ...
        let state = crate::serve::ServerState {
            ...
            active_file: Arc::new(tokio::sync::RwLock::new(String::new())),
            models: Arc::new(RwLock::new(vec![ModelInfo { id: "m1".into(), context_window: None, reasoning_efforts: vec![] }])),
